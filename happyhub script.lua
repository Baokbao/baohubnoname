...
-- Hàm để cập nhật các thuộc tính của activeController
...
-- Chạy vòng lặp để điều khiển thời gian tấn công và thời gian dừng
spawn(function()
    while true do
        if _G.FastAttack then
...
-- Cập nhật giá trị Stun và Busy của nhân vật
spawn(function()
    while true do
...
elseif World3 then
	tableBoss = {"Banana hub By bao Raid Boss [Lv. 3000]","Stone","Island Empress","Kilo Admiral","Captain Elephant","Beautiful Pirate","rip_indra True Form","Longma","Soul Reaper","Cake Queen"}
end
